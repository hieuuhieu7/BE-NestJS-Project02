...
import { Subscriber, SubscriberDocument } from 'src/subscribers/schemas/subscriber.entity';
...
export class MailController {
  ...
  @Cron("0 10 0 * * 0") // 10h07 sáng thứ 7 hàng tuần
